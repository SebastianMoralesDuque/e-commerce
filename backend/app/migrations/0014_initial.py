# Generated by Django 4.2.1 on 2023-06-19 23:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0013_remove_carrito_producto_remove_carrito_usuario_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='pedido',
            name='ventas',
            field=models.ManyToManyField(through='app.Venta', to='app.producto'),
        ),
        migrations.CreateModel(
            name='DireccionEnvio',
            fields=[
